    ...
    <>
      ...
      >
        ...
        <div className="h-full flex flex-col">
          <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-background/50">
        ...
        <motion.button
          className="absolute top-2 sm:top-2.5 md:top-3 right-2 sm:right-2.5 md:right-3
                     p-2 rounded-full bg-muted/80 text-foreground hover:bg-muted
      ...
      >
        <motion.div
          className="relative rounded-xl bg-secondary/20 backdrop-blur-xl
